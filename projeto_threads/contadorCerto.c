...
* Cada thread incrementa a variável global 'contagem' NITERACOES vezes
* @param pArg: ponteiro para argumentos da thread (não utilizado)
* @return: NULL
*/
void *contador(void *pArg) {
	int i;
...
* @param pshared: indica se o semáforo será compartilhado entre processos (0 para threads do mesmo processo)
